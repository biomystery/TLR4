...
for i = 2:numel(hillCoeffient)
    plot(alldose,ikkPeak{i}(2,1:20),'-o','color',colors{3}+mulips{3}*colGrad(i),...
         'linewidth',1.5)
    hold on ;
end
plot(alldose,ikkPeak{1}(1,1:20),'-og','linewidth',1.5)
...
for i = 2:numel(hillCoeffient)
    plot(alldose,ikkPeakT{i}(2,1:20),'-o','color',colors{3}+mulips{3}*colGrad(i),...
         'linewidth',1.5)
    hold on ;
end

plot(alldose,ikkPeakT{1}(1,1:20),'-og','linewidth',1.5)
set(gca,'xscale','linear','fontsize',16,'xscale','log'...
        ,'xtick',[1e-4 1 1e+4])
xlim([1e-4 1e+4])
xlabel('LPS dose (ng/ml)')
...
for i = 2:numel(hillCoeffient)
    plot(alldose,nfkbPeak{i}(2,1:20),'-o','color',colors{3}+mulips{3}*colGrad(i),...
         'linewidth',1.5)
    hold on ;
end
plot(alldose,nfkbPeak{1}(1,1:20),'-og','linewidth',1.5)
set(gca,'xscale','linear','fontsize',16,'xscale','log'...
        ,'xtick',[1e-4 1 1e+4])
xlim([1e-4 1e+4])
xlabel('LPS dose (ng/ml)')
...
for i = 2:numel(hillCoeffient)
    plot(alldose,nfkbPeakT{i}(2,1:20),'-o','color',colors{3}+mulips{3}*colGrad(i),...
         'linewidth',1.5)
    hold on ;
end
plot(alldose,nfkbPeakT{1}(1,1:20),'-og','linewidth',1.5)
set(gca,'xscale','linear','fontsize',16,'xscale','log'...
        ,'xtick',[1e-4 1 1e+4])
xlim([1e-4 1e+4])
xlabel('LPS dose (ng/ml)')
